...
export default function Write() {
    ...
    <div className="write">
        ...
        <form className="writeForm" onSubmit={handleSubmit}>
            ...
            <div className="writeFormGroup">
                <TextEditor className='writeText writeInput' initialValue="" getValue={getValue} placeholder="Tell your Story..." />
            </div>
            <input type="text"  placeholder='Multiple Tags with comma seprated' className='writeTags' onChange={handleTags}/>
